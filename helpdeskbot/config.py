...
TELEGRAM_HELP_DESK_BOT_WEBHOOK_URL = os.getenv("TELEGRAM_HELP_DESK_BOT_WEBHOOK_URL", "https://vas3k.club/telegram/helpdeskbot/webhook/")
TELEGRAM_HELP_DESK_BOT_WEBHOOK_HOST = "0.0.0.0"
TELEGRAM_HELP_DESK_BOT_WEBHOOK_PORT = 8817
# SECURITY: webhook authentication secret (same fix as the main bot)
TELEGRAM_HELP_DESK_BOT_WEBHOOK_SECRET = os.getenv("TELEGRAM_HELP_DESK_BOT_WEBHOOK_SECRET")
