...
def command_help(update: Update, context: CallbackContext) -> None:
    update.effective_chat.send_message(
        "✖️ Я — глупая бездушная машина Вастрик.Клуба\n\n"
        "Через меня можно отвечать на комменты и посты — просто напишите "
        "ответ в реплае и я перепостю его в Клуб. "
        "Так можно общаться в комментах даже не открывая сайт.\n\n"
        "Чтобы плюсануть — реплайните +.\n\n"
        "Еще я знаю разные команды:"
