<template>
    ...
    >
        ...
        <div class="comment-rating">
            ...
            <div v-if="isPinned" class="comment-pinned-icon"><i class="fas fa-thumbtack"></i></div>
        </div>
...
<script>
import PinAction from "./actions/PinAction.vue";
...
export default {
    name: "Comment",
    components: { PinAction, EditAction, DeleteAction, ReplyAction, AuthorSection },
    props: {
        id: {
            type: String,
            required: true,
