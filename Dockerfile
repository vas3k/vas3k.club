FROM ghcr.io/astral-sh/uv:0.10.12-python3.12-trixie-slim AS python-builder
...
FROM node:22-slim@sha256:9c2c405e3ff9b9afb2873232d24bb06367d649aa3e6259cbe314da59578e81e9 AS frontend-builder
