...
class PostFavourite(models.Model):
    ...
    user = models.ForeignKey(User, related_name="favourites", db_index=True, on_delete=models.CASCADE)
    post = models.ForeignKey(Post, related_name="favourites", db_index=True, on_delete=models.CASCADE)

    created_at = models.DateTimeField(auto_now_add=True)

    class Meta:
        db_table = "post_favourites"
