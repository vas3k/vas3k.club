...
class PostGuideForm(PostForm):
    ...
    text = forms.CharField(
        ...
        required=True,
        max_length=500000,
        initial="Ниже приведён шаблон, который вы можете редактировать как вам угодно. "
                ...
                "# Основная информация\n\n"
                "- **Валюта** [название, курс и как проще его запомнить]\n"
                "- **Население** [количество человек]\n"
                "- **Визы** [нужна ли соклубникам виза и какая]\n"
                "- **Когда лучше всего приезжать?** [месяц или сезон]\n"
                "- **Что обязательно взять с собой?** [переходник для розеток, крем от солнца, или просто ничего]\n"
                "- **Как лучше добраться из аэропорта?** [можно несколько вариантов]\n"
                "- **Как лучше перемещаться по городу?** [взять билет на несколько дней или пользоваться такси?]\n"
                "- **Как вызывать такси?** [название приложения или телефон]\n"
                "- **Есть ли доставка еды?** [название приложения]\n"
                "- **Какую купить туристическую симку?** [название и как купить]\n"
                "- **Можно ли везде платить картой?** [да, либо сумма денег, которую надо снять]\n"
                "- **Можно ли пить воду из крана?** [да/нет/ваш вариант]\n"
                "- **Главные супермаркеты для еды?** [названия и чем отличаются]\n"
                "- **Говорят ли люди на улице по-английски?** [и как к ним обращаться за помощью]\n"
                "- **Что нужно 100% увидеть и попробовать?** [места, люди, явления]\n"
                "- **Чего остерегаться?** [места, люди, явления]\n"
                "- **Сколько в среднем стоит 1 шаурма?** [в местной валюте]\n\n"
