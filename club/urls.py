...
from posts.views.admin import admin_post, announce_post, curate_post, full_view_post
...
urlpatterns = [
    ...
    path("post/<slug:post_slug>/full_view/", full_view_post, name="full_view_post"),
