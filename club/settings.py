...
SUPPORTED_TIME_ZONES = [
    ("UTC", "по UTC"),
    ("Europe/Lisbon", "по Лиссабону (UTC+1)"),
    ("Europe/London", "по Лондону (UTC+1)"),
    ("Europe/Dublin", "по Дублину (UTC+1)"),
    ("Europe/Berlin", "по Берлину (UTC+2)"),
    ("Europe/Amsterdam", "по Амстердаму (UTC+2)"),
    ("Europe/Paris", "по Парижу (UTC+2)"),
    ("Europe/Rome", "по Риму (UTC+2)"),
    ("Europe/Prague", "по Праге (UTC+2)"),
    ("Europe/Vienna", "по Вене (UTC+2)"),
    ("Europe/Warsaw", "по Варшаве (UTC+2)"),
    ("Europe/Zurich", "по Цюриху (UTC+2)"),
    ("Europe/Stockholm", "по Стокгольму (UTC+2)"),
    ("Europe/Copenhagen", "по Копенгагену (UTC+2)"),
    ("Europe/Madrid", "по Барселоне (UTC+2)"),
    ("Europe/Madrid", "по Мадриду (UTC+2)"),
    ("Europe/Belgrade", "по Белграду (UTC+2)"),
    ("Africa/Johannesburg", "по Кейптауну (UTC+2)"),
    ("Europe/Athens", "по Афинам (UTC+3)"),
    ("Europe/Helsinki", "по Хельсинки (UTC+3)"),
    ("Europe/Kyiv", "по Киеву (UTC+3)"),
    ("Europe/Riga", "по Риге (UTC+3)"),
    ("Europe/Tallinn", "по Таллину (UTC+3)"),
    ("Europe/Vilnius", "по Вильнюсу (UTC+3)"),
    ("Europe/Chisinau", "по Кишиневу (UTC+3)"),
    ("Europe/Istanbul", "по Стамбулу (UTC+3)"),
    ("Europe/Moscow", "по Москве (UTC+3)"),
    ("Europe/Moscow", "по Санкт-Петербургу (UTC+3)"),
    ("Europe/Tbilisi", "по Тбилиси (UTC+4)"),
    ("Asia/Yerevan", "по Еревану (UTC+4)"),
    ("Europe/Samara", "по Самаре (UTC+4)"),
    ("Asia/Yekaterinburg", "по Екатеринбургу (UTC+5)"),
    ("Asia/Omsk", "по Омску (UTC+6)"),
    ("Asia/Novosibirsk", "по Новосибирску (UTC+7)"),
    ("Asia/Krasnoyarsk", "по Красноярску (UTC+7)"),
    ("Asia/Irkutsk", "по Иркутску (UTC+8)"),
    ("Asia/Yakutsk", "по Якутску (UTC+9)"),
    ("Asia/Vladivostok", "по Владивостоку (UTC+10)"),
    ("Asia/Magadan", "по Магадану (UTC+11)"),
    ("Asia/Kamchatka", "по Камчатке (UTC+12)"),
    ("Asia/Tokyo", "по Токио (UTC+9)"),
    ("Asia/Seoul", "по Сеулу (UTC+9)"),
    ("Asia/Hong_Kong", "по Гонконгу (UTC+8)"),
    ("Asia/Shanghai", "по Шанхаю (UTC+8)"),
    ("Asia/Singapore", "по Сингапуру (UTC+8)"),
    ("Asia/Kuala_Lumpur", "по Куала-Лумпуру (UTC+8)"),
    ("Asia/Bangkok", "по Таиланду (UTC+7)"),
    ("Asia/Dubai", "по Дубаю (UTC+4)"),
    ("Asia/Jerusalem", "по Израилю (UTC+3)"),
    ("Asia/Almaty", "по Алматы (UTC+6)"),
    ("Australia/Sydney", "по Сиднею (UTC+10)"),
    ("Pacific/Auckland", "по Окленду (UTC+12)"),
    ("America/Argentina/Buenos_Aires", "по Буэнос-Айресу (UTC-3)"),
    ("America/Sao_Paulo", "по Сан-Паулу (UTC-3)"),
    ("America/New_York", "по Нью-Йорку (UTC-4)"),
    ("America/Chicago", "по Чикаго (UTC-5)"),
    ("America/Denver", "по Денверу (UTC-6)"),
    ("America/Los_Angeles", "по Лос-Анджелесу (UTC-7)"),
    ("America/Vancouver", "по Ванкуверу (UTC-7)"),
    ("America/Mexico_City", "по Мехико (UTC-6)"),
    ("America/Toronto", "по Торонто (UTC-4)"),
]
