...
ALLOWED_HOSTS = ["*", "127.0.0.1", "localhost", "0.0.0.0", "4aff.club"]
INTERNAL_IPS = ["127.0.0.1"]

ADMINS = [
    ("admin", "4affclub@gmail.com"),
]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "4aff club <4affclub@gmail.com>")
...
STRIPE_ACTIVE = os.getenv("STRIPE_ACTIVE", False)
...
WAYFORPAY_SECRET = os.getenv("WAYFORPAY_SECRET") or ""
