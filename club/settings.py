...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "Улан.Клуб <club@ulan-club.com>")
...
AUTH_MAX_CODE_TIMEDELTA = timedelta(seconds=3)
...
TELEGRAM_BOT_URL = os.getenv("TELEGRAM_BOT_URL") or "https://t.me/UlanClubBot"
...
TELEGRAM_BOT_WEBHOOK_URL = "https://ulan-club.com/telegram/webhook/"
