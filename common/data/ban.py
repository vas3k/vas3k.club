...
PROGRESSIVE_BAN_DAYS = [0, 3, 7, 15, 30, 60, 180, 365]  # in case of 0 it takes "min_duration" from ban reason
...
TEMPORARY_BAN_REASONS = {
    ...
    "useless": BanReason(
        ...
        description="В правилах Клуба сказано, что мы здесь не любим бесполезные негативные комментарии, "
                    "которые не добавляют ничего нового дискуссии, а лишь транслируют хейтспич. "
    ...
    "disrespect": BanReason(
        ...
        description="Если вам так не нравится Клуб и те, кто его поддерживает, то возможно вам стоит найти "
                    "другую площадку, которая даст вашему креативу раскрыться? В интернете их много, не Клубом единым.",
        min_duration=5
    ),
}
