ACHIEVEMENTS = [
    ...
    ("parliament_member", {
        ...
        "image": "https://i.4aff.club/2582c2df41eb67114307e22ffee862fe923ab1843ce47781aee577cc3f2abb5f.jpg",
        "style": "background-color: #000000; font-size: 120%;",
    }),
    ("contributor", {
        "name": "Контри-бьютор",
        "description": "За значительный вклад в разработку Клуба",
        "image": "https://i.4aff.club/3ah.png",
    ...
    ("oscar", {
        ...
        "image": "https://i.4aff.club/3bd.png",
    ...
    ("offline", {
        ...
        "image": "https://i.4aff.club/3ai.png",
    ...
    ("altruist", {
        ...
        "image": "https://i.4aff.club/3d0.png",
    ...
    ("ideas", {
        ...
        "image": "https://i.4aff.club/3d1.png",
